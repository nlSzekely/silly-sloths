...
export default function Section1() {
    return (
        <Grid container mt={'40px'} sx={{padding: 3}}>
            <Grid item xs={12} lg={6} sx={styles.contentContainer} justifyContent='center' container>
                <Marquee
                    pauseOnHover
            ...
            <Grid sx={styles.contentContainer} container xs={12} lg={6} justifyContent='center' >
                <Typography
